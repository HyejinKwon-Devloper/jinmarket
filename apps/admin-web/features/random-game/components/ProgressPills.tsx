      ...
      {steps.map((step, index) => {
        ...
        return (
          <div
            ...
            className={`inline-flex min-w-0 items-center justify-center rounded-full border px-2 py-2 text-[11px] font-semibold uppercase tracking-[0.14em] transition sm:px-3 sm:text-xs sm:tracking-[0.18em] ${
              isCurrent
