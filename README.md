...
- 로컬 개발
  - `NEXT_PUBLIC_API_BASE_URL=https://jinmarket.test:4100`
  - `API_PROXY_TARGET=https://jinmarket.test:4100`
  - `NEXT_PUBLIC_SHOP_APP_URL=https://jinmarket.test:3100`
  - `NEXT_PUBLIC_ADMIN_APP_URL=https://jinmarket.test:3200`
...
- 구매 사이트: `https://jinmarket.test:3100`
- 어드민 사이트: `https://jinmarket.test:3200`
- API 헬스체크: `https://jinmarket.test:4100/health`
